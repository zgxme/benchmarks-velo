-- TODO(zgx) move to session sql dir
ALTER ACCOUNT
SET
  use_cached_result = FALSE;
  
create
or replace TABLE CALL_CENTER cluster by (cc_call_center_sk)(
...
create
or replace TABLE CATALOG_PAGE cluster by (cp_catalog_page_sk)(
...
create or replace TABLE CATALOG_RETURNS cluster by ( cr_returned_date_sk, cr_item_sk )(
...
create
or replace TABLE CATALOG_SALES cluster by (cs_sold_date_sk, cs_item_sk)(
...
create
or replace TABLE CUSTOMER_ADDRESS cluster by (ca_address_sk)(
...
create
or replace TABLE CUSTOMER_DEMOGRAPHICS cluster by (cd_demo_sk)(
...
create
or replace TABLE CUSTOMER cluster by (c_customer_sk)(
...
create
or replace TABLE DATE_DIM cluster by (d_date_sk)(
...
create
or replace TABLE HOUSEHOLD_DEMOGRAPHICS cluster by (hd_demo_sk)(
...
create
or replace TABLE INCOME_BAND cluster by (ib_income_band_sk)(
...
create
or replace TABLE INVENTORY cluster by (inv_date_sk, inv_item_sk)(
...
create
or replace TABLE ITEM cluster by (i_item_sk)(
...
create
or replace TABLE PROMOTION cluster by (p_promo_sk)(
...
create
or replace TABLE REASON cluster by (r_reason_sk)(
...
create
or replace TABLE SHIP_MODE cluster by (sm_ship_mode_sk)(
...
create
or replace TABLE STORE_RETURNS cluster by (sr_returned_date_sk, sr_item_sk)(
...
create
or replace TABLE STORE_SALES cluster by (ss_sold_date_sk, ss_item_sk)(
...
create
or replace TABLE STORE cluster by (s_store_sk)(
...
create
or replace TABLE TIME_DIM cluster by (t_time_sk)(
...
create
or replace TABLE WAREHOUSE cluster by (w_warehouse_sk)(
...
create
or replace TABLE WEB_PAGE cluster by (wp_web_page_sk)(
...
create
or replace TABLE WEB_RETURNS cluster by (wr_returned_date_sk, wr_item_sk)(
...
create
or replace TABLE WEB_SALES cluster by (ws_sold_date_sk, ws_item_sk)(
...
create
or replace TABLE WEB_SITE cluster by (web_site_sk)(
