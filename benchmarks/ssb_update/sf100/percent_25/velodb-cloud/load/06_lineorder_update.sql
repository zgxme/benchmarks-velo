-- 25% Update: Insert partial lineorder data (simulating 25% update)
-- Note: Loads first 2 lineorder files (files 1-2 of 10)
INSERT INTO lineorder (
    lo_orderkey,lo_linenumber,lo_custkey,lo_partkey,lo_suppkey,lo_orderdate,lo_orderpriority,lo_shippriority,lo_quantity,lo_extendedprice,lo_ordtotalprice,lo_discount,lo_revenue,lo_supplycost,lo_tax,lo_commitdate,lo_shipmode
        ...
        "uri" = "s3://bench-dataset/ssb/sf100/lineorder/lineorder.tbl.1.gz",
        "format" = "csv",
...
INSERT INTO lineorder (
    lo_orderkey,lo_linenumber,lo_custkey,lo_partkey,lo_suppkey,lo_orderdate,lo_orderpriority,lo_shippriority,lo_quantity,lo_extendedprice,lo_ordtotalprice,lo_discount,lo_revenue,lo_supplycost,lo_tax,lo_commitdate,lo_shipmode
        ...
        "uri" = "s3://bench-dataset/ssb/sf100/lineorder/lineorder.tbl.2.gz",
        "format" = "csv",
        "s3.endpoint" = "https://s3.us-east-1.amazonaws.com",
        "s3.region" = "us-east-1",
        "column_separator" = "|",
