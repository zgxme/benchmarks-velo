...
create or replace TABLE LINEITEM cluster by LINEAR(L_SHIPDATE)(
...
create or replace TABLE ORDERS cluster by LINEAR(O_ORDERDATE)(
...
create or replace TABLE PARTSUPP cluster by LINEAR(PS_SUPPKEY)(
